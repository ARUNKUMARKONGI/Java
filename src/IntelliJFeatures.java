public class IntelliJFeatures {
    public static void main(String[] args) {
        ...
        11. First create git repository for new project in intellij by checking version control
         to push project to github repository, right click on project folder name, go to git
